...
$query="INSERT INTO table_name (field_name,sender,receiver,file,size) values('$data','$sender','$epr','$f','$file_size') "; //”field_name” is the name of the field where we are uploading pdf files
...
$result1 = mysqli_query($link, $query); //query execution
}
